...
id=raw_input('Enter User id')                                                          #id will take a name/number as a ID
NumofImgs=0
...
while(1):
    ...
    for (x,y,w,h) in faces:
        NumofImgs+=1
        cv2.imwrite("dataSet/User." + str(id) + "." + str(NumofImgs)+ ".jpg", gray[y:y+h,x:x+w])  #saves the image in a folder "dataSet" 
