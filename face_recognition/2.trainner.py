...
recognizer=cv2.createLBPHFaceRecognizer();                                             #Local Binary Patterns Histogram is a texture operator which labels the pixels of an image by thresholding the neighbourhood of each pixel and considers result as a binary number.
